 ...
 */
public class NrYesPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public NrYesPagerAdapter(FragmentManager fm, Context context) {
        super(fm);

        Resources resources = context.getResources();
        mTitles = resources.getStringArray(R.array.nrY_titles);
        mHeaders = resources.getStringArray(R.array.nrY_headers);
        mBodies = resources.getStringArray(R.array.nrY_bodies);
