 ...
 */
public class NrNoPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public NrNoPagerAdapter(FragmentManager fm, Context context) {
        super(fm);

        Resources resources = context.getResources();
        mTitles = resources.getStringArray(R.array.nrN_titles);
        mHeaders = resources.getStringArray(R.array.nrN_headers);
        mBodies = resources.getStringArray(R.array.nrN_bodies);
