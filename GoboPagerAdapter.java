 ...
 */
public class GoboPagerAdapter extends FragmentStatePagerAdapter {
    ...
    final int[] mMainImageResourceIds =
            {
                    ...
                    R.drawable.gobo_bulkhead_fit,
                    R.drawable.gobo_spacing,

            };

    public GoboPagerAdapter(FragmentManager fm, Context context) {
        super(fm);

        Resources resources = context.getResources();
        mTitles = resources.getStringArray(R.array.gobo_titles);
        mHeaders = resources.getStringArray(R.array.gobo_headers);
        mBodies = resources.getStringArray(R.array.gobo_bodies);
