 ...
 */
public class DimmerNoPagerAdapter extends FragmentStatePagerAdapter {
    ...
    final int[] mMainImageResourceIds =
            {
                    ...
                    R.drawable.dimmer_spacing_cmy,
                    R.drawable.dimmer_spacing_lamp
            };

    public DimmerNoPagerAdapter(FragmentManager fm, Context context) {
        super(fm);

        Resources resources = context.getResources();
        mTitles = resources.getStringArray(R.array.dimmerN_titles);
        mHeaders = resources.getStringArray(R.array.dimmerN_headers);
        mBodies = resources.getStringArray(R.array.dimmerN_bodies);
